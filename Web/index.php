...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero-card {
            width: 540px; /* Ocupa todo el contenedor */
            height: 300px;
            position: relative;
...
<body>
                    ...
                    <div class="nav-bar">
                        <div class="nav-content">
                            ...
                            <div class="search-container">
                                <input type="text" id="search-input" class="search-input" placeholder="Buscar" onchange="handleSearch()">
                            ...
                            <div class="header-icons">
                                ...
                                <button class="header-icon-btn" onclick="handleAddToCart(title)"><ion-icon name="cart-outline"></ion-icon></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    var configures = [];
            ...
            try {
                ...
                try {
                    ...
                    if(resPerfil.ok) {
                        ...
                        if(!data.success) {
                            console.warn("Error al obtener perfil:", data);
            ...
            return `
                <div class="card">
                    <div class="card-image-container">
                        <img src="${product.image}" class="card-image" onerror="this.src='${MOCK_PHONE_IMG}'" onclick='handleToProduct("${empaquetado(product)}")'>
        ...
        function handleSearch() {
            ...
            if (text.trim()) {
                window.location.href = `buscar.html?search=${encodeURIComponent(text)}`;
            }
        }
